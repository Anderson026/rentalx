...
var UersRepositoryInMemory_1 = require("@modules/accounts/repositories/in-memory/UersRepositoryInMemory");
...
var sendForgotPasswordMailUserCase;
...
describe("Send Forgot Mail", function () {
    beforeEach(function () {
        usersRepositoryInMemory = new UersRepositoryInMemory_1.UsersRepositoryInMemory();
        ...
        sendForgotPasswordMailUserCase = new SendForgotPasswordMailUseCase_1.SendForgotPasswordMailUseCase(usersRepositoryInMemory, usersTokensRepositoryInMemory, dateProvider, mailProvider);
    });
    it("should be able to send a forgot password mail to user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, sendForgotPasswordMailUserCase.execute("emailTest@email.com")];
                case 2:
                    _a.sent();
    ...
    it("should not be able to send an email if user does not exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, expect(sendForgotPasswordMailUserCase.execute("emailPass@emial.com")).rejects.toEqual(new AppError_1.AppError("User does not exists!"))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sendForgotPasswordMailUserCase.execute("emailTest1@email.com")];
                case 1:
                    _a.sent();
